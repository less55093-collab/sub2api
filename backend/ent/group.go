...
type GroupEdges struct {
	...
	// APIKeysMulti holds the value of the api_keys_multi edge.
	APIKeysMulti []*APIKey `json:"api_keys_multi,omitempty"`
...
// APIKeysMultiOrErr returns the APIKeysMulti value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) APIKeysMultiOrErr() ([]*APIKey, error) {
	if e.loadedTypes[1] {
		return e.APIKeysMulti, nil
	}
	return nil, &NotLoadedError{edge: "api_keys_multi"}
}
...
// QueryAPIKeysMulti queries the "api_keys_multi" edge of the Group entity.
func (_m *Group) QueryAPIKeysMulti() *APIKeyQuery {
	return NewGroupClient(_m.config).QueryAPIKeysMulti(_m)
}
